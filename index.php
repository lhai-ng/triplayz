...
<main>
    <section class="min-h-[unset] md:min-h-screen relative overflow-hidden p-6 md:p-10">
        <img src="assets/images/bn.jpg" class="w-full h-full absolute top-0 left-0 object-cover" alt="">
        ...
        <div class="relative md:absolute z-3 bottom-0 right-0 px-0 md:px-10 max-w-full xl:max-w-[60%] text-center md:text-left">
            ...
            <div class="py-6 2xl:py-8 3xl:py-10 border-t border-[#FFFFFF26] block md:flex items-center justify-between gap-6 md:gap-16 2xl:gap-8 3xl:gap-10 text-left md:text-center">
                <div class="item anek max-w-121 w-full text-center md:text-center mb-6 md:mb-0">
    ...
    <section class="min-h-[unset] lg:min-h-screen overflow-hidden flex items-center justify-center text-center py-20 lg:py-0">
    ...
    <section class="py-10 md:py-20 lg:py-25 3xl:py-50 px-6 md:px-10 relative overflow-hidden">
    ...
    <section class="py-20 lg:py-25 px-10 relative overflow-hidden hidden md:block">
